...
The live application is still the standard OwlSolutions admin kit. See [STATUS.md](STATUS.md).
...
Exact public URL, branding, and whether analysis is behind a gate (email, waitlist, payment) are **Open questions**.
